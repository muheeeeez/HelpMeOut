  ...
  <div>
    ...
    <div class="container">
      ...
      <div class="authentication">
        <button @click="openGoogleInNewTab">
        ...
        <button @click="openFacebookInNewTab">
          <div class="button-details">
            <svg
              width="25"
              height="24"
      ...
      <div class="form">
        ...
        <div>
          ...
          <input type="email" placeholder="Enter your email Password" />
        </div>
      </div>
      <input type="button" value="Sign up" class="submit-button" />
    </div>
  </div>
</template>
